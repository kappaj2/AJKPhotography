...
<html:form action="/admin/galleryMaintenanceAction" method="post" enctype="multipart/form-data">
    ...
    <table border="0"  class="TableMaintenance">
        <tr>
            <th colspan="2" class="th1"><bean:message key="title.page.gallery.edit" /></th>
        </tr>
        ...
        <tr>
            <th class="tr1" align="right">Gallery Image</th>
            <td class="tr1" align="left"><html:text readonly="true" property="galleryImageUrl"/></td>
        </tr>        
        <tr>
    ...
    <html:hidden property="exec" value="updateGallery" />
</html:form>
